...
export const EditPatient = () =>{
    return(
        // Yang simpan ini juga belom aku set alertnya ndo, masih bingung
        ...
        <form className=" needs-validation" noValidate>
            ...
            {/* Kurang Live Alertnya */}
            <div className=" d-flex justify-content-center col-12 ">
            <Button className="btn btn-dark" style={{marginRight:'10px'}} onClick={() => { }}>Batal</Button> 
